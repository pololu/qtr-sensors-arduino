...
For documentation, please see the "user's guide":http://www.pololu.com/docs/0J19 for the library on Pololu's website. A "printable PDF":http://www.pololu.com/docs/pdf/0J19/pololu_avr_library.pdf of the guide is also available.
